...
type ServerConfig struct {
	...
	PasetoPublicKey  string                 `protobuf:"bytes,6,opt,name=paseto_public_key,json=pasetoPublicKey,proto3" json:"paseto_public_key,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ServerConfig) GetAuthMethod() string {
	if x != nil {
		return x.AuthMethod
	}
	return ""
...
func (x *ServerConfig) GetPasetoPublicKey() string {
	if x != nil {
		return x.PasetoPublicKey
	}
	return ""
}
...
const file_proxy_http_config_proto_rawDesc = "" +
	...
	"authMethod\x12*\n" +
	"\x11paseto_public_key\x18\x06 \x01(\tR\x0fpasetoPublicKey\x1a;\n" +
